if (window.top === window){
    ...
    (function() {
     ...
     safari.extension.dispatchMessage("RotateTabs",{Direction:true,Modifiers:modifiers});
     }
     else if((modifiers&ALT)===ALT ){
     safari.extension.dispatchMessage("RotateTabs",{Direction:false,Modifiers:modifiers});
     }
     ...
     Rotation=false;
     safari.extension.dispatchMessage("ActivateRecent",{Direction:false,Modifiers:modifiers});
     }
     }
